...
const onSubmit = async (values: IValues, { setSubmitting }: FormikActions<IValues>) => {
...
const SubscriptionDialog: React.FunctionComponent = () => (
    <Formik
      ...
      onSubmit={onSubmit}
    >
      {({handleSubmit, handleChange, handleBlur, values, isValid, errors, submitCount, isSubmitting}) => (
        <React.Fragment>
